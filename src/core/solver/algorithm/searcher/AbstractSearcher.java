...
public abstract class AbstractSearcher {
    ...
    /**
     * 重置 frontier 的最大值统计（在开始新问题前调用）
     */
    public void resetFrontierMax() {
        frontier.resetMaxSize();
    }

    /**
     * 返回当前 frontier 统计到的最大大小
     */
    public int getFrontierMaxSize() {
        return frontier.getMaxSize();
    }
